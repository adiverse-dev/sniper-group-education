...
const defenceSlides = [
 {
 img: IMAGE_PATHS.defence.hero.intro,
 imgPos: "top center",
 tag: "Sniper Defence Academy",
 accent: "#FF9933",
 heading: "Forge Your Path to National Service",
 sub: `India's trusted defence coaching — preparing warriors ${COMPANY_TEXT.sinceFounded}. Join 1,200+ successful selections.`,
 stats: [{ val: "200+", lab: "Selections" }, { val: COMPANY_TEXT.yearsPlus, lab: "Years" }, { val: "98%", lab: "Success Rate" }, { val: "50+", lab: "Faculty" }],
 btn: "Explore Courses",
 link: "/defence",
 },
 {
 img: IMAGE_PATHS.defence.hero.aissee,
 imgPos: "top center",
 tag: "AISSEE",
 accent: "#FF9933",
 ...
 {
 img: IMAGE_PATHS.defence.hero.upssee,
 imgPos: "top center",
 tag: "UPSSEE",
 accent: "#FF9933",
 ...
 {
 img: IMAGE_PATHS.defence.hero.rims,
 imgPos: "top center",
 tag: "RMS",
 accent: "#FF9933",
 ...
 {
 img: IMAGE_PATHS.defence.hero.rimc,
 imgPos: "top center",
 tag: "RIMC",
 accent: "#FF9933",
 ...
 {
 img: IMAGE_PATHS.defence.hero.cdsNda,
 imgPos: "top center",
 tag: "CDS & NDA",
 accent: "#FF9933",
 ...
 {
 img: IMAGE_PATHS.defence.hero.airforceXy,
 imgPos: "top center",
 tag: "Air Force X & Y",
 accent: "#FF9933",
...
const CourseDetail = ({ course, activeDetail, setActiveDetail }) => {
 ...
 <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "12px", padding: "14px 16px", background: "white", borderRadius: "12px", border: "1px solid #f1e8d8" }}>
 <div style={{ width: "26px", height: "26px", borderRadius: "50%", background: "rgba(255,153,0,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", color: "#FF9933", flexShrink: 0, fontWeight: 700 }}>P</div>
 <span style={{ fontSize: "14px", color: "#1e293b", fontWeight: 500, lineHeight: 1.6 }}>{item}</span>
 </div>
 ))}
 </div>
 ...
 Call to Enquire About {course.name}
 </a>
 </div>
 </div>
 );
