export const COMPANY_PROFILE = {
  name: "Jai Sipper Group",
  brandName: "Sniper Group of Education",
  trustName: "Bhagwan Parshuram Education & Charitable Trust",
  foundedYear: 2020,
  completedYears: 6,
...
export const COMPANY_TEXT = {
  yearsPlus: `${COMPANY_PROFILE.completedYears}+`,
