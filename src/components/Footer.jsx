  ...
  return (
    <footer style={{ background: "#0a1628", color: "white", fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div style={{ background: "linear-gradient(90deg, #e8420a, #ff6b35)", padding: "18px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
        ...
        <a href="https://wa.me/917060155711" target="_blank" rel="noreferrer" style={{ background: "white", color: "#e8420a", padding: "8px 22px", borderRadius: "999px", fontWeight: 700, fontSize: "14px", textDecoration: "none", whiteSpace: "nowrap" }}>
          Enquire Now →
        </a>
      </div>
      ...
      <div className="footer-grid" style={{ maxWidth: "1180px", margin: "0 auto", padding: "60px 40px 40px", display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1fr", gap: "40px" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "18px" }}>
            <div style={{ width: "44px", height: "44px", borderRadius: "10px", background: "linear-gradient(135deg, #e8420a, #ff6b35)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: "20px", color: "white" }}>S</div>
            <div>
              <div style={{ fontWeight: 800, fontSize: "16px", letterSpacing: "1px", color: "white" }}>SNIPER</div>
              <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.5)", letterSpacing: "2px", textTransform: "uppercase" }}>Group of Education</div>
            </div>
          </div>
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              ...
              <li key={item.path}>
                <Link to={item.path} style={{ color: "rgba(255,255,255,0.65)", fontSize: "14px", textDecoration: "none", display: "flex", alignItems: "center", gap: "8px", transition: "color 0.2s" }}
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "12px" }}>
            {[
              ...
              <li key={item.path}>
                <Link to={item.path} style={{ color: "rgba(255,255,255,0.65)", fontSize: "14px", textDecoration: "none", transition: "color 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "white"}
                  onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.65)"}>
                  → {item.label}
                </Link>
