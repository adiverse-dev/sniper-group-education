      ...
      <div className="max-w-[1180px] mx-auto">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: "48px", alignItems: "start" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            {/* YouTube Video — directly below heading */}
          ...
          {/* RIGHT — Trust heading + description */}
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div>
              ...
              <p style={{ fontSize: "15px", color: "#64748b", lineHeight: 1.75 }}>
                Founded with a vision to provide quality education and defence training to the youth of India. Our trust has been shaping futures and serving society since 2020
                .
              </p>
            </div>
            ...
            <p style={{ fontSize: "15px", color: "#475569", lineHeight: 1.85 }}>
              We are governed by <strong style={{ color: "#0d1b3e" }}>Bhagwan Parshuram Education & Charitable Trust</strong> — a registered trust committed to uplifting society through quality education and character-building since 2020.
            </p>
            <p style={{ fontSize: "15px", color: "#475569", lineHeight: 1.85 }}>
              Our mission is to make world-class education and defence training accessible to every child, regardless of background.
            </p>
          </div>
